...
var DFPManager = Object.assign(new _events.EventEmitter().setMaxListeners(0), {
  ...
  destroyGPTSlots: function destroyGPTSlots() {
    ...
    var registeredSlotObjects = slotsToDestroy.map(function (slotId) {
      return registeredSlots[slotId];
        ...
        googletag.cmd.push(function () {
          if (managerAlreadyInitialized === true) {
            if (registeredSlotObjects.length > 0) {
              ...
              try {
                for (var _iterator = registeredSlotObjects[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
